...
function convertGermanWord(word, keepUnknownS = false) {
    ...
    */
    ...
    const exactMatchesList = (typeof EXACT_MATCHES !== 'undefined' ? EXACT_MATCHES : (typeof globalThis !== 'undefined' ? globalThis.EXACT_MATCHES : {}))[cleanWord[0]];
    if (exactMatchesList) {
    ...
    const namesList = (typeof LONG_S_NAMES !== 'undefined' ? LONG_S_NAMES : (typeof globalThis !== 'undefined' ? globalThis.LONG_S_NAMES : {}))[cleanWord[0]];
    if (namesList) {
    ...
    */
    const forcedOverwrites = typeof FORCED_OVERWRITES !== 'undefined' ? FORCED_OVERWRITES : (typeof globalThis !== 'undefined' ? globalThis.FORCED_OVERWRITES : []);
    for (let term of forcedOverwrites) {
    ...
    */
    ...
    let endsList = null;
    const endPatterns = typeof END_PATTERNS !== 'undefined' ? END_PATTERNS : (typeof globalThis !== 'undefined' ? globalThis.END_PATTERNS : {});
    if (blueprintWord.length >= 3) {
        endsList = endPatterns[blueprintWord.slice(-3)];
    }
    if (!endsList && blueprintWord.length >= 2) {
        endsList = endPatterns[blueprintWord.slice(-2)];
    }
    if (!endsList && blueprintWord.length >= 1) {
        endsList = endPatterns[blueprintWord.slice(-1)];
    }
    ...
    */
    ...
    const omnipresentMap = typeof OMNIPRESENT_PATTERNS !== 'undefined' ? OMNIPRESENT_PATTERNS : (typeof globalThis !== 'undefined' ? globalThis.OMNIPRESENT_PATTERNS : {});

    wordKeys.forEach(wordKey => {
        if (omnipresentMap[wordKey]) {
            if (omnipresentMap[wordKey][sCount]) {
                omnipresentPatterns = omnipresentPatterns.concat(
                    omnipresentMap[wordKey][sCount]
                );
            }
            if (sCount === 2 && omnipresentMap[wordKey][1]) {
                omnipresentPatterns = omnipresentPatterns.concat(
                    omnipresentMap[wordKey][1]
                );
            }
        }
    });
    ...
    */
    ...
    const startPatternsMap = typeof START_PATTERNS !== 'undefined' ? START_PATTERNS : (typeof globalThis !== 'undefined' ? globalThis.START_PATTERNS : {});
    const startsList = startPatternsMap[blueprintWord[0]];
    if (
        startsList
    ...
    */
    const postprocessList = typeof POSTPROCESS_PATTERNS !== 'undefined' ? POSTPROCESS_PATTERNS : (typeof globalThis !== 'undefined' ? globalThis.POSTPROCESS_PATTERNS : []);
    for (let term of postprocessList) {
        if (!remainingBlankIndices.some(i => cleanWord[i] === UNKNOWN_S)) break;
        [cleanWord, madeReplacement] = _crosswordReplace(cleanWord, term);
        if (madeReplacement) {
            cleanWord = _fillInDoubleS(cleanWord);
    ...
    */
    if (keepUnknownS) {
        cleanWord = cleanWord.replace(new RegExp(UNKNOWN_S, 'g'), 'X');
    } else if (DEFAULT_UNKNOWNS_TO_LONG_S) {
...
if (typeof globalThis !== 'undefined') {
    globalThis.UNKNOWN_S = UNKNOWN_S;
    globalThis._stripToGermanAlphabet = _stripToGermanAlphabet;
    globalThis.cartesianProduct = cartesianProduct;
    globalThis.escapeRegex = escapeRegex;
    globalThis._crosswordReplace = _crosswordReplace;
    globalThis._blueprintReplace = _blueprintReplace;
    globalThis._fillInDoubleS = _fillInDoubleS;
    globalThis._findBlankIndices = _findBlankIndices;
    globalThis.convertGermanWord = convertGermanWord;
}
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        UNKNOWN_S,
        _stripToGermanAlphabet,
        cartesianProduct,
        escapeRegex,
        _crosswordReplace,
        _blueprintReplace,
